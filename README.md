# Ohmyfood
Troisième projet du parcours "Développeur d'application - JavaScript React". L'objectif de ce projet est de dynamiser une page web avec des animations CSS.
...
- L'approche utilisée doit être mobile-first, toutefois le site doit être responsive sur tablette et desktop.
